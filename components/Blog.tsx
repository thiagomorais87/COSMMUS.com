  ...
  return (
    <div className="bg-transparent py-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <p className="text-gray-400 mb-12">Mantenha-se atualizado com o Boletim Cosmmus.</p>

        {/* Resource Types */}
        <div className="grid md:grid-cols-3 gap-6 mb-16">
            <div className="bg-brand-surface p-6 rounded-xl border border-white/5 flex items-center gap-4">
                <BookOpen className="text-brand-cyan w-8 h-8" />
                <div>
                    <h3 className="font-bold text-white">Blog & E-books</h3>
                    <p className="text-sm text-gray-400">Artigos técnicos e guias.</p>
                </div>
            </div>
            <div className="bg-brand-surface p-6 rounded-xl border border-white/5 flex items-center gap-4">
                ...
                <div>
                    ...
                    <p className="text-sm text-gray-400">Conversas com especialistas.</p>
                </div>
            </div>
            <div className="bg-brand-surface p-6 rounded-xl border border-white/5 flex items-center gap-4">
                ...
                <div>
                    ...
                    <p className="text-sm text-gray-400">Assine o Boletim Cosmmus.</p>
                </div>
            </div>
        </div>

        {/* Recent Posts */}
        <h2 className="text-2xl font-bold mb-8">Recentes no Blog</h2>
        <div className="grid md:grid-cols-3 gap-8">
          {posts.map((post, idx) => (
            <article key={post.id} className="bg-white/5 rounded-xl p-6 hover:bg-white/10 transition-colors border border-white/5">
